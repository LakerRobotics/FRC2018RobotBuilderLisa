...
public class OI {
    ...
    public OI() {
        ...
        driverLeftBumper.whileHeld(new ArcadeDrive());
        driverLeftTrigger = new JoystickButton(driver, 2);
        driverLeftTrigger.whileHeld(new ArcadeDrive());
        driverRightBumper = new JoystickButton(driver, 6);
        driverRightBumper.whenPressed(new CatapultLaunch(0.1));
        driverRightTrigger = new JoystickButton(driver, 3);
        ...
        SmartDashboard.putData("DriveStright", new DriveStright());
