...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("DriveStraightAtAngle: Test", new DriveStraightAtAngle(60, 1, 45));
        SmartDashboard.putData("DriveStraightAtAngle: backward", new DriveStraightAtAngle(-60, 1, 45));
        SmartDashboard.putData("DriveStraightAtAngle: negAngle", new DriveStraightAtAngle(60, 1, -45));
        SmartDashboard.putData("DriveStop", new DriveStop());
        SmartDashboard.putData("DriveTurnTo: toNintyDegree", new DriveTurnTo(90));
        SmartDashboard.putData("DriveTurnTo: fullSpinTo360", new DriveTurnTo(360));
        SmartDashboard.putData("DriveTurnTo: TenSpinsTo3600", new DriveTurnTo(3600));
        ...
        SmartDashboard.putData("DriveSquareFastNotPrecise", new DriveSquareFastNotPrecise());
        ...
        SmartDashboard.putData("CatapultLaunch: SCALE_CATAPULT_DELAY", new CatapultLaunch(10));
        SmartDashboard.putData("Left intake", new Leftintake());
        SmartDashboard.putData("PrintGyro", new PrintGyro());
        SmartDashboard.putData("DriveZeroDriveDistenceEncoders", new DriveZeroDriveDistenceEncoders());
        SmartDashboard.putData("DriveZeroGyro", new DriveZeroGyro());
        SmartDashboard.putData("DriveTestTreePattern", new DriveTestTreePattern());

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        SmartDashboard.putData("PrintRobotSpeed", new PrintRobotSpeed());      
        SmartDashboard.putData("PrintRobotDistance", new PrintRobotDistance());      
