...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("DriveStraight: TestShort", new DriveStraight(12, 2));
        SmartDashboard.putData("DriveStraight: TestLong", new DriveStraight(36, 2));
        SmartDashboard.putData("DriveStraight: Test6ft", new DriveStraight(72, 1));
        SmartDashboard.putData("DriveStraight: TestBackward", new DriveStraight(-72, 1));
        SmartDashboard.putData("DriveStraight: TeStFast", new DriveStraight(36, 5));
