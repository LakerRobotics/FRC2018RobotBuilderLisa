...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("DriveStraightAtAngle: Test", new DriveStraightAtAngle(45, 36));
        SmartDashboard.putData("DriveStraightAtAngle: backward", new DriveStraightAtAngle(45, -36));
        SmartDashboard.putData("DriveStraightAtAngle: negAngle", new DriveStraightAtAngle(-45, 36));
        ...
        SmartDashboard.putData("DriveZeroRobot", new DriveZeroRobot());
