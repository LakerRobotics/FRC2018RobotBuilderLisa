...
*/
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
        ...
        addSequential(new DriveStraightAtAngle(48 ,speed, 0));
        addSequential(new DriveTurnArc(36+38, speed, -24));
        addSequential(new DriveTurnArc(36+38+38*2, speed, 24));
        addSequential(new DriveStraightAtAngle(24,speed, 90));
        addSequential(new DriveTurnArc(/*36+38+38*2+*/24+38*2, speed, 24));
        addSequential(new DriveTurnArc(/*36+38+38*2+*/24+38*2+38, speed, -24));
        addSequential(new DriveStraightAtAngle(48, speed, 180));
