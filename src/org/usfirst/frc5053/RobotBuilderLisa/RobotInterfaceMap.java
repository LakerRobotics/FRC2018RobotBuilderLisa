...
//		
		public RobotInterfaceMap(Joystick aDriverJoystick, JoystickType driverJoystickType, 
				                 Joystick aOpperatorJoystick, JoystickType operatorJoystickType) {
		driverJoystick = aDriverJoystick;
		operatorJoystick = aOpperatorJoystick;
		if (driverJoystickType.equals(JoystickType.XBOX)){
			//XBOX driver
			driverButtonA = 1;
			driverButtonB = 2;
			driverButtonX = 3;
		...
		if (operatorJoystickType.equals(JoystickType.XBOX))
		{
			//XBOX operator
			operatorButtonA = 1;
			operatorButtonB = 2;
