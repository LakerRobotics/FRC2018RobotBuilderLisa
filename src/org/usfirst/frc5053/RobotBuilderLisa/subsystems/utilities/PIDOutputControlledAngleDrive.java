...
import edu.wpi.first.wpilibj.PIDOutput;
	 ...
	 *
	 */
	public class PIDOutputControlledAngleDrive implements PIDOutput {
		...
		public PIDOutputControlledAngleDrive(DriveTrainMotionControl drivetrain, PIDSource turnSource, double targetAngle) 
		{
	    ...
	    private class WrapRotationPIDOutput implements PIDOutput 
	    {
	        ...
	        private PIDOutputControlledAngleDrive m_RotationPowerDestination;

	        public WrapRotationPIDOutput(PIDOutputControlledAngleDrive rotationPowerDesintation) 
	        {
